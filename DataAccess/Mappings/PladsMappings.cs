...
namespace DataAccess.Mappings
{
    internal static class PladsMappings
    {
        ...
        {
            return new DTO.Model.Plads(daPlads.PladsId, (DTO.Model.Varegruppe)daPlads.Varegruppe, daPlads.ReolId, daPlads.PladsX, daPlads.PladsY);
        }

        internal static DataAccess.Model.Plads Map(this DTO.Model.Plads dtoPlads)
        {
            return new DataAccess.Model.Plads((DataAccess.Model.Varegruppe)dtoPlads.Varegruppe, dtoPlads.ReolId, dtoPlads.PladsX, dtoPlads.PladsY);
        }
